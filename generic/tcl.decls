...
declare 3 generic {
    char * Tcl_Alloc(Tcl_Length size)
}
declare 4 generic {
    void Tcl_Free(char *ptr)
}
declare 5 generic {
    char * Tcl_Realloc(char *ptr, Tcl_Length size)
}
declare 6 generic {
    char * Tcl_DbCkalloc(Tcl_Length size, CONST char *file, int line)
}
declare 7 generic {
    int Tcl_DbCkfree(char *ptr, CONST char *file, int line)
}
declare 8 generic {
    char * Tcl_DbCkrealloc(char *ptr, Tcl_Length size,
...
declare 41 generic {
    char * Tcl_GetStringFromObj(Tcl_Obj *objPtr, Tcl_Length *lengthPtr)
}
declare 42 generic {
...
declare 58 generic {
    unsigned char * Tcl_SetByteArrayLength(Tcl_Obj *objPtr, Tcl_Length length)
}
declare 59 generic {
...
declare 64 generic {
    void Tcl_SetObjLength(Tcl_Obj *objPtr, Tcl_Length length)
}
declare 65 generic {
...
declare 77 generic {
    char Tcl_Backslash(CONST char *src, Tcl_Length *readPtr)
}
declare 78 generic {
...
declare 85 generic {
    int Tcl_ConvertCountedElement(CONST char *src, int length,
				  char *dst, int flags)
}
declare 86 generic {
...
declare 124 generic {
    void Tcl_DStringSetLength(Tcl_DString *dsPtr, Tcl_Length length)
}
declare 125 generic {
...
declare 176 generic {
    char * Tcl_GetVar2(Tcl_Interp *interp, char *part1, char *part2,
	    int flags)
}
declare 177 generic {
...
declare 206 generic {
    int Tcl_Read(Tcl_Channel chan, char *bufPtr, Tcl_Length toRead)
}
...
declare 262 generic {
    ClientData Tcl_VarTraceInfo2(Tcl_Interp *interp, char *part1, char *part2,
...
declare 320 generic {
    Tcl_UniChar Tcl_UniCharAtIndex(CONST char *src, Tcl_Length index)
}
declare 321 generic {
...
declare 326 generic {
    int Tcl_UtfCharComplete(CONST char *src, Tcl_Length len)
}
declare 327 generic {
...
declare 359 generic {
    void Tcl_LogCommandInfo (Tcl_Interp *interp, char *script, char *command,
	    int length)
}
declare 360 generic {
    int Tcl_ParseBraces (Tcl_Interp *interp, char *string, int numBytes,
...
declare 370 generic {
    int Tcl_UtfNcasecmp(CONST char *s1, CONST char *s2, Tcl_Length n)
}
declare 371 generic {
...
declare 380 generic {
    Tcl_Length Tcl_GetCharLength (Tcl_Obj *objPtr)
}
declare 381 generic {
    Tcl_UniChar Tcl_GetUniChar (Tcl_Obj *objPtr, Tcl_Length index)
}
declare 382 generic {
    Tcl_UniChar * Tcl_GetUnicode (Tcl_Obj *objPtr)
}
declare 383 generic {
    Tcl_Obj * Tcl_GetRange(Tcl_Obj *objPtr, Tcl_Length first, Tcl_Length last)
}
declare 384 generic {
...
# Introduced in 8.3.2
declare 394 generic {
    int Tcl_ReadRaw (Tcl_Channel chan, char *dst, Tcl_Length bytesToRead)
}
declare 395 generic {
...
declare 428 generic {
    char * Tcl_AttemptAlloc(Tcl_Length size)
}
declare 429 generic {
    char * Tcl_AttemptDbCkalloc(Tcl_Length size, char *file, int line)
}
declare 430 generic {
    char * Tcl_AttemptRealloc(char *ptr, Tcl_Length size)
}
declare 431 generic {
    char * Tcl_AttemptDbCkrealloc(char *ptr, Tcl_Length size,
				  char *file, int line)
}
declare 432 generic {
    int Tcl_AttemptSetObjLength(Tcl_Obj *objPtr, Tcl_Length length)
}
declare 433 generic {
...
declare 444 generic {
    int	Tcl_FSLoadFile(Tcl_Interp * interp, Tcl_Obj *pathPtr, char * sym1,
...
declare 447 generic {
    int	Tcl_FSRemoveDirectory(Tcl_Obj *pathPtr, int recursive,
	    Tcl_Obj **errorPtr)
}
declare 448 generic {
...
declare 451 generic {
    int Tcl_FSFileAttrsGet(Tcl_Interp *interp, int index, Tcl_Obj *pathPtr,
	    Tcl_Obj **objPtrRef)
}
declare 452 generic {
    int Tcl_FSFileAttrsSet(Tcl_Interp *interp, int index, Tcl_Obj *pathPtr,
	    Tcl_Obj *objPtr)
}
declare 453 generic {
